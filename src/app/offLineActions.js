...
export function startOffLinePomodoro(payload){
  dispatcher.dispatch(webSocketActions({event: Action.PomodoroStarted, timer_id: payload.timer_id, pomodoro_id: payload.pomodoro_id, description: payload.description, shared_with: [] }))
  timer_id = setTimeout(() => {
    dispatcher.dispatch(webSocketActions({event: Action.PomodoroCompleted, timer_id: payload.timer_id, pomodoro_id: payload.pomodoro_id, description: payload.description, shared_with:[] }))
    timer_id = null
  }, settings.duration)
}
